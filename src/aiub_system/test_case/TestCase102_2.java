...
public class TestCase102_2 {
	...
	public void chkWhyStudyHere() {
		...
		try {
			...
			act.moveToElement(driver.findElement(By.xpath("/html[1]/body[1]/div[3]/div[1]/div[2]/ul[2]/li[2]/a[1]")))
					.build().perform();
			Thread.sleep(2000);
			driver.findElement(By.xpath("/html[1]/body[1]/div[3]/div[1]/div[2]/ul[2]/li[2]/ul[1]/li[4]/a[1]")).click();
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public static void main(String[] args) {
		...
		TestCase102_2 obj = new TestCase102_2();
