...
public class TestCase102_3_10 {
	...
	public void chkConvocation() {
		try {
			...
			Thread.sleep(2000);
			driver.findElement(By.xpath("/html[1]/body[1]/div[4]/div[1]/div[2]/div[1]/div[1]/div[2]/a[10]")).click();
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public static void main(String[] args) {
		...
		TestCase102_3_10 obj = new TestCase102_3_10();
		obj.invokeBrowser();
		obj.chkConvocation();
