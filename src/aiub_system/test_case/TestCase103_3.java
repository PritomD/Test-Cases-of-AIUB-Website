...
public class TestCase103_3 {
	...
	public void chkCourseAndFee() {
		...
		try {
			...
			Thread.sleep(2000);
			driver.findElement(By.xpath("/html[1]/body[1]/div[3]/div[1]/div[2]/ul[2]/li[3]/ul[1]/li[2]/a[1]")).click();
	...
	public static void main(String[] args) {
		...
		TestCase103_3 obj = new TestCase103_3();
