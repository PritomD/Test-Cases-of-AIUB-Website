...
public class TestCase102_3_0 {
	...
	public void chkConvocation() {
		try {
			...
			act.moveToElement(driver.findElement(By.xpath("/html[1]/body[1]/div[3]/div[1]/div[2]/ul[2]/li[2]/a[1]"))).build().perform();
			Thread.sleep(2000);
	...
	public static void main(String[] args) {
		...
		TestCase102_3_0 obj = new TestCase102_3_0();
		obj.invokeBrowser();
		obj.chkConvocation();
