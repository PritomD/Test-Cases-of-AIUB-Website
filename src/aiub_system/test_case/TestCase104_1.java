...
public class TestCase104_1 {
	...
	public void chkFaculties() {
			...
			try {
				...
				Thread.sleep(2000);
				driver.findElement(By.xpath("/html[1]/body[1]/div[3]/div[1]/div[2]/ul[2]/li[5]/ul[1]/li[4]/a[1]")).click();
	...
	public static void main(String[] args) {
		...
		TestCase104_1 obj = new TestCase104_1();
